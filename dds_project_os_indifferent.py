...
# os.makedirs(os.path.join(WORKING_DIRECTORY,'slike'))
...
plt.grid(True)
plt.savefig(os.path.join(WORKING_DIRECTORY,'slike','sincx_korekcija.pdf'),bbox_inches='tight')
plt.show()
# ================================================================================================================================================
...
plt.legend(loc='upper left')
plt.grid(True)
plt.savefig(os.path.join(WORKING_DIRECTORY,'slike','varijacija_amplitude_fir.pdf'),bbox_inches='tight')
plt.show()
# ================================================================================================================================================
...
plt.xlim(0,100)
plt.grid(True)
plt.savefig(os.path.join(WORKING_DIRECTORY,'slike','fazni_akumulator_izlaz.pdf'),bbox_inches='tight')
plt.show()
# ================================================================================================================================================
...
plt.xlim(0,100)
plt.grid(True)
plt.savefig(os.path.join(WORKING_DIRECTORY,'slike','cordic_sample.pdf'),bbox_inches='tight')
plt.show()
# ================================================================================================================================================
...
plt.legend(loc='upper left')
plt.grid(True)
plt.savefig(os.path.join(WORKING_DIRECTORY,'slike','cordic_fft.pdf'),bbox_inches='tight')
plt.show()
# ================================================================================================================================================
...
plt.grid(True)
plt.savefig(os.path.join(WORKING_DIRECTORY,'slike','da_sample_no_filter.pdf'),bbox_inches='tight')
plt.show()
# ================================================================================================================================================
...
plt.xlim(0,300)
plt.grid(True)
plt.savefig(os.path.join(WORKING_DIRECTORY,'slike','lp_fft.pdf'),bbox_inches='tight')
plt.show()
# ================================================================================================================================================
...
plt.grid(True)
plt.savefig(os.path.join(WORKING_DIRECTORY,'slike','da_fft.pdf'),bbox_inches='tight')
plt.show()
# ================================================================================================================================================
...
plt.xlabel("$t$ [us] ")
plt.grid(True)
plt.savefig(os.path.join(WORKING_DIRECTORY,'slike','da_ifft.pdf'),bbox_inches='tight')
plt.show()
# ================================================================================================================================================
...
plt.xlabel("$t$ [s]")
plt.grid(True)
plt.savefig(os.path.join(WORKING_DIRECTORY,'slike','da_brz_sample.pdf'),bbox_inches='tight')
plt.show()
# ================================================================================================================================================
...
plt.grid(True)
plt.savefig(os.path.join(WORKING_DIRECTORY,'slike','bp_fft.pdf'),bbox_inches='tight')
plt.show()
# ================================================================================================================================================
...
plt.legend(loc='upper left')
plt.grid(True)
plt.savefig(os.path.join(WORKING_DIRECTORY,'slike','da_brz_fft.pdf'),bbox_inches='tight')
plt.show()
# ================================================================================================================================================
...
plt.xlim(0,1000)
plt.grid(True)
plt.savefig(os.path.join(WORKING_DIRECTORY,'slike','da_brz_ifft.pdf'),bbox_inches='tight')
plt.show()
# ================================================================================================================================================
